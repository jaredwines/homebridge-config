...
exports.prefixLogger = exports.miredToKelvin = exports.lookupCharacteristicNameByUUID = exports.lookup = exports.kelvinToMired = exports.hasCharacteristic = exports.getOrAddCharacteristic = exports.delay = exports.deferAndCombine = exports.isObjectLike = void 0;
...
function getOrAddCharacteristic(service, characteristic) {
    if (!hasCharacteristic(service.characteristics.concat(service.optionalCharacteristics), characteristic)) {
...
function hasCharacteristic(characteristics, characteristic) {
    return (characteristics.find((char) => char instanceof characteristic || char.UUID === characteristic.UUID) !== undefined);
}
exports.hasCharacteristic = hasCharacteristic;
