...
class TplinkAccessory {
    constructor(platform, config, homebridgeAccessory, tplinkDevice, category, services) {
        ...
        this.hkDevice = (0, create_1.default)(platform, tplinkDevice, category);
        this.name = this.hkDevice.name;
        this.log = (0, utils_1.prefixLogger)(platform.log, () => `${chalk_1.default.blue(`[${this.name}]`)}`);
        ...
        const accInfo = (0, accessory_information_1.default)(platform.api.hap)(this.homebridgeAccessory, this.hkDevice);
    ...
    setupCharacteristics(service, characteristicTypes) {
        ...
        characteristicTypes.forEach((CharacteristicType) => {
            if (this.hkDevice.supportsCharacteristic(CharacteristicType)) {
                const characteristic = (0, utils_1.getOrAddCharacteristic)(service, CharacteristicType);
            ...
            if ((0, utils_1.hasCharacteristic)(service.characteristics.concat(service.optionalCharacteristics), CharacteristicType)) {
