...
class HomeKitDeviceBulb extends _1.default {
    constructor(platform, tplinkDevice, category) {
        ...
        this.getLightState = (0, utils_1.deferAndCombine)((requestCount) => {
        ...
        this.setLightState = (0, utils_1.deferAndCombine)((requestCount) => {
        ...
        this.getRealtime = (0, utils_1.deferAndCombine)(() => {
    ...
    addBasicCharacteristics() {
        ...
        const updateListener = (lightState) => {
            ...
            if (lightState.color_temp != null && lightState.color_temp > 0) {
                this.fireCharacteristicUpdateCallback(this.platform.Characteristic.ColorTemperature, Math.round((0, utils_1.kelvinToMired)(lightState.color_temp)));
    ...
    addColorTemperatureCharacteristics() {
        ...
        this.addCharacteristic(this.platform.Characteristic.ColorTemperature, {
            props: {
                minValue: Math.ceil((0, utils_1.kelvinToMired)(max)),
                maxValue: Math.floor((0, utils_1.kelvinToMired)(min)), // K and Mired are reversed
            },
            getValue: async () => {
                var _a;
                this.getLightState().catch(this.logRejection.bind(this)); // this will eventually trigger update
                ...
                if (typeof ls.color_temp === 'number' && ls.color_temp > 0) {
                    return Math.round((0, utils_1.kelvinToMired)(ls.color_temp));
                }
                if (typeof ((_a = ls.dft_on_state) === null || _a === void 0 ? void 0 : _a.color_temp) === 'number' &&
                    ls.dft_on_state.color_temp > 0) {
                    return Math.round((0, utils_1.kelvinToMired)(ls.dft_on_state.color_temp));
                }
                if (!('color_temp' in ls)) {
                    return Math.floor((0, utils_1.kelvinToMired)(min));
                }
                return Math.floor((0, utils_1.kelvinToMired)(min));
            },
            setValue: async (value) => {
                ...
                if (typeof value === 'number') {
                    await this.setLightState({
                        color_temp: Math.round((0, utils_1.miredToKelvin)(value)),
                    });
                    return;
                }
